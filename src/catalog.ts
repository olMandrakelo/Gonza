...
export const CATALOG_ITEMS: CatalogItem[] = [
  ...
  { name: 'Torniquete (CAT)', category: 'Salud' },
  { name: 'Gasa hemostática', category: 'Salud' },
  { name: 'Kit de sutura de emergencia', category: 'Salud' },
  { name: 'Collarín cervical improvisado', category: 'Salud' },
  { name: 'Cabestrillo / inmovilizador de brazo', category: 'Salud' },
  { name: 'Espray antiséptico', category: 'Salud' },
  { name: 'Parche ocular', category: 'Salud' },
  { name: 'Gotas oculares', category: 'Salud' },
  { name: 'Gotas óticas', category: 'Salud' },
  { name: 'Jarabe para la tos', category: 'Salud' },
  { name: 'Loperamida', category: 'Salud' },
  { name: 'Laxante', category: 'Salud' },
  { name: 'Antiinflamatorio en gel', category: 'Salud' },
  { name: 'Crema para rozaduras', category: 'Salud' },
  { name: 'Protector labial con FPS', category: 'Salud' },
  { name: 'Pastillas para el mareo', category: 'Salud' },
  { name: 'Manual de primeros auxilios', category: 'Salud' },
  ...
  { name: 'Yesca natural / algodón con vaselina', category: 'Herramientas' },
  { name: 'Lana de acero (encendido)', category: 'Herramientas' },
  { name: 'Astillas de fatwood (palo santo resinoso)', category: 'Herramientas' },
  { name: 'Pastillas de encendido (cubos de fuego)', category: 'Herramientas' },
  { name: 'Lupa de encendido solar', category: 'Herramientas' },
  { name: 'Caja hermética para yesca y fósforos', category: 'Herramientas' },
  { name: 'Mechero tipo soplete (a prueba de viento)', category: 'Herramientas' },
  { name: 'Cerillas de tormenta (larga duración)', category: 'Herramientas' },
